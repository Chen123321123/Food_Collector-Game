...
public class IceBoard extends Board {
    ...
    private int bananaCollected = 0;
    private int iceCreamCollected = 0;
    private int cherryCollected = 0;
    private int whipCreamCollected = 0;
    ...
    protected void collectIngredient(Ingredient ingredient) {
        switch (ingredient.getName()) {
            case "banana" -> bananaCollected++;
            case "iceCream" -> iceCreamCollected++;
            case "cherry" -> cherryCollected++;
            case "whipCream" -> whipCreamCollected++;
            case "milkshake" -> bonusMilkshakeCollected = true;
        }
    }
    ...
    public int getBananaCollected() { return bananaCollected; }
    public int getIceCreamCollected() { return iceCreamCollected; }
    public int getCherryCollected() { return cherryCollected; }
    public int getWhipCreamCollected() { return whipCreamCollected; }
