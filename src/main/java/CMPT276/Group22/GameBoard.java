...
public class GameBoard extends JFrame {
    ...
    public GameBoard(String boardType) {
        ...
        // Create the board first so we can check its type
        ...
        // Add all components to frame in correct order
    ...
    private void initializeTopPanel() {
        topPanel = new JPanel();
        topPanel.setLayout(new FlowLayout(FlowLayout.LEFT, 10, 5)); // Simple left-aligned layout
    ...
    private void initializeGameStatsPanel() {
        ...
        gameStatsPanel.setBackground(new Color(240, 240, 240));
        ...
        // Set fixed size for stats panel
    ...
    private void initializeIngredientsPanel() {
        ...
        ingredientsPanel.setBackground(new Color(240, 240, 240));
        
        // Create sub-panels with more compact layout
        ...
        ingredientTrackingPanel.setBackground(new Color(240, 240, 240));
        
        // Store reference to tracking panel for updates
        ...
        // Add panels to ingredients panel with specific size constraints
        ingredientTrackingPanel.setPreferredSize(new Dimension(200, 150));
        ingredientTrackingPanel.setMaximumSize(new Dimension(200, 150));
        ingredientsPanel.add(ingredientTrackingPanel);
        
        ingredientsPanel.add(Box.createVerticalStrut(10)); // Reduced spacing
        ingredientsPanel.add(recipeVisPanel);
        
        // Set overall panel size
        ingredientsPanel.setPreferredSize(new Dimension(200, 400));
    }
    ...
    private String getCurrentBoardType() {
        if (currentBoard instanceof FireBoard) return "fire";
        if (currentBoard instanceof IceBoard) return "ice";
        if (currentBoard instanceof EarthBoard) return "earth";
        return "fire"; // default
    }
    ...
    private void addIngredientLabel(String name, int collected, int target) {
        ...
        label.setFont(new Font("Arial", Font.PLAIN, 11));  // Smaller font
        label.setAlignmentX(Component.CENTER_ALIGNMENT);
        ingredientTrackingPanel.add(label);
        ingredientTrackingPanel.add(Box.createVerticalStrut(3));  // Reduced spacing between labels
    }
