...
public class FireBoard extends Board {
    ...
    private int chiliCollected = 0;
    private int brothCollected = 0;
    ...
    protected void spawnBonusIngredient() {
        ...
        BonusIngredient bonus = new BonusIngredient(new Coordinate(y, x), bonusValue, "bonusIngredient", bonusDuration, this);
    ...
    public int getChiliCollected() { return chiliCollected; }
    public int getBrothCollected() { return brothCollected; }
    public int getMeatCollected() { return meatCollected; }
