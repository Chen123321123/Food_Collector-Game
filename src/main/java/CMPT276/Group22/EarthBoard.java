...
public class EarthBoard extends Board {
    ...
    //public static final int DRUMSTICK_TARGET = 2;
    
    private int dalCollected = 0;
    private int potatoCollected = 0;
    private int carrotCollected = 0;
    private int onionCollected = 0;
    //private int drumstickCollected = 0;
    ...
    protected void collectIngredient(Ingredient ingredient) {
        switch (ingredient.getName().toLowerCase()) {  // Convert to lowercase
            case "dal" -> dalCollected++;
            case "potato" -> potatoCollected++;
            case "carrot" -> carrotCollected++;
            case "onion" -> onionCollected++;
            //case "drumstick" -> drumstickCollected++;
            case "rice" -> bonusRiceCollected = true;
        }
    }
    ...
    protected int getTargetForIngredient(String ingredient) {
        switch (ingredient.toLowerCase()) {
            ...
            //case "drumstick": return DRUMSTICK_TARGET;
            default: return 0;
        }
    }

    public int getDalCollected() { return dalCollected; }
    public int getPotatoCollected() { return potatoCollected; }
    public int getCarrotCollected() { return carrotCollected; }
    public int getOnionCollected() { return onionCollected; }
    //public int getDrumstickCollected() { return drumstickCollected; }
